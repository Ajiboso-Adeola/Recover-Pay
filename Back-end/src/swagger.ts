  ...
  paths: {
    "/plans": {
      post: {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  amount: { type: "number", example: 5000, description: "Naira amount e.g. 5000 = ₦5,000" },
        ...
        responses: { "201": { description: "Plan created" }, "400": { description: "Validation error" } },
      },
      get: { summary: "List plans", tags: ["Plans"], responses: { "200": { description: "Array of plans" } } },
    },
    "/plans/{id}": {
      get: {
        summary: "Get a plan",
    ...
    "/checkout/start": {
      post: {
        ...
        responses: {
          "200": { description: "Returns a Nomba checkoutUrl to redirect the customer to" },
    ...
    "/subscriptions": {
      get: {
        ...
        tags: ["Subscriptions"],
        parameters: [{ name: "status", in: "query", required: false, schema: { type: "string", enum: ["created", "trialing", "active", "past_due", "paused", "cancelled"] } }],
    ...
    "/subscriptions/{id}/charge": {
      post: {
        ...
        description: "Useful for demos — in production the scheduler fires this automatically",
        tags: ["Subscriptions"],
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }],
        responses: {
    ...
    "/portal/{customerId}": {
      get: {
        ...
        responses: { "200": { description: "Customer + subscriptions" }, "404": { description: "Not found" } },
      },
    },
    ...
    "/webhooks/nomba": {
      post: {
        ...
        description: "Not for manual calls — this endpoint receives payment events from Nomba",
        tags: ["Webhooks"],
        security: [],
